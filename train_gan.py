...
from trainer.trainer_gan import Trainer
...
def main(config, resume):
    ...
    optimizer = dict()
    optimizer['generator'] = optimizer_class(generator_trainable_params,
                                             **config['optimizer']['args'])
    optimizer['discriminator'] = optimizer_class(discriminator_trainable_params,
                                                 **config['optimizer']['args'])
...
if __name__ == '__main__':
    ...
    if args.config:
        ...
        # Use '--config' and '--resume' together to
        # fine-tune trained model with changed configurations.
